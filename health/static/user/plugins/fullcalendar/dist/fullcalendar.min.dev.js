 ...
 */
!function (t) {
  "function" == typeof define && define.amd ? define(["jquery", "moment"], t) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? module.exports = t(require("jquery"), require("moment")) : t(jQuery, moment);
}(function (t, e) {
  function n(t) {
    return it(t, Qt);
  }
  ...
  function Nt(n) {
    var i,
        ...
        o,
        a = Zt.dataAttrPrefix;
    return a && (a += "-"), i = n.data(a + "event") || null, i && (i = "object" == _typeof(i) ? t.extend({}, i) : {}, r = i.start, null == r && (r = i.time), s = i.duration, o = i.stick, delete i.start, delete i.time, delete i.duration, delete i.stick), null == r && (r = n.data(a + "start")), null == r && (r = n.data(a + "time")), null == s && (s = n.data(a + "duration")), null == o && (o = n.data(a + "stick")), r = null != r ? e.duration(r) : null, s = null != s ? e.duration(s) : null, o = Boolean(o), {
      eventProps: i,
      startTime: r,
      duration: s,
      stick: o
    ...
    function o(i) {
      ...
      return s && t.each(s.split(" "), function (n) {
        ...
        t.each(this.split(","), function (n, i) {
          ...
          "title" == i ? (s = s.add(t("<h2>&nbsp;</h2>")), l = !1) : ((r = o[i]) ? (h = function h(t) {
            r.click && r.click.call(w[0], t);
          }, c = "", d = r.text) : (u = e.getViewSpec(i)) ? (h = function h() {
            e.changeView(i);
          }, v.push(i), c = u.buttonTextOverride, d = u.buttonTextDefault) : e[i] && (h = function h() {
            e[i]();
  ...
  function Ut() {
    ...
    function f(e, n) {
      ...
      for (i = 0; i < s.length; i++) {
        ...
        if ("object" == _typeof(r)) return void f(r, n);
      }
    ...
    t.each((q.opt("events") ? [q.opt("events")] : []).concat(q.opt("eventSources") || []), function (t, e) {
      ...
      for (e = 0; e < Q.length; e++) {
        if (n = Q[e].events, t.isArray(n)) for (i = 0; i < n.length; i++) {
          N(n[i]);
        }
      }
  ...
  be.mixin({
    ...
    buildSegDragListener: function buildSegDragListener(t) {
      ...
      var h = this.segDragListener = new ye(a, {
        ...
        hitOver: function hitOver(e, o, l) {
          var c,
              d,
              f,
              g = !0;
    ...
    buildSegResizeListener: function buildSegResizeListener(t, e) {
      ...
      return this.segResizeListener = new ye(this, {
        ...
        hitOver: function hitOver(n, o, l) {
          var u = !0,
    ...
    eventsToSegs: function eventsToSegs(e, n) {
      ...
      return t.each(r, function (t, e) {
        ...
        if (kt(e[0])) for (l = i.invertRanges(l), o = 0; o < l.length; o++) {
  ...
  var Ee = Zt.DayTableMixin = {
    ...
    sliceRangeByRow: function sliceRangeByRow(t) {
      ...
      for (e = 0; e < this.rowCnt; e++) {
        n = e * o, i = n + o - 1, r = Math.max(l, n), s = Math.min(u, i), r = Math.ceil(r), s = Math.floor(s), r <= s && h.push({
          row: e,
    ...
    sliceRangeByDay: function sliceRangeByDay(t) {
      ...
      for (e = 0; e < this.rowCnt; e++) {
        for (n = e * a, i = n + a - 1, r = n; r <= i; r++) {
          s = Math.max(u, r), o = Math.min(h, r), s = Math.ceil(s), o = Math.floor(o), s <= o && c.push({
            row: e,
  ...
  var Te = Zt.TimeGrid = be.extend(Ee, {
    ...
    sliceRangeByTimes: function sliceRangeByTimes(t) {
      ...
      for (n = 0; n < this.daysPerRow; n++) {
        i = this.dayDates[n].clone().time(0), r = {
  ...
  Re.mixin({
    ...
    buildViewSpec: function buildViewSpec(t) {
      for (var i, r, s, o, a, l = this.overrides.views || {}, u = [], h = [], c = [], d = t; d;) {
        i = $t[d], r = l[d], d = null, "function" == typeof i && (i = {
          "class": i
